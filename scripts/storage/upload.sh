...
# Show inputs
echo "Source directory: $sourceDirName"
...
az storage blob upload-batch --account-name "$accountName" --account-key "$accountKey" --destination "$containerName" --source "$sourceDirName"
